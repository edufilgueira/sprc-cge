...
# actually its a gem https://github.com/objects-on-rails/fig-leaf
# but to avoid bundle a gem outside the main project (SPRC) its copied
# here. If approved by maintainers we can add it to Gemfile
