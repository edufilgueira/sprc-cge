...
namespace :cities do
  desc 'Cria ou atualiza os municípios do Brasil'
  task create_or_update: :environment do

    def import_cities(cities)
      cities.each do |city_attributes|
        state_code = city_attributes[0]
        code = city_attributes[1]
        name = city_attributes[2]

        city = City.find_or_initialize_by(code: code)
    ...
    # fonte de dados: https://ww2.ibge.gov.br/home/estatistica/populacao/estimativa2016/estimativa_dou.shtm
    cities = [
