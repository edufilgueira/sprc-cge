...
describe SiteMapHelper do
  context 'transparency' do
    it 'default' do
      ...
      expect(site_map_transparency_default).to eq(expected)
    end
    ...
    it 'news_sections' do
      ...
      expect(site_map_transparency_news_sections).to eq(expected)
    end
    ...
    it 'revenues' do
      ...
      expect(site_map_transparency_revenues).to eq(expected)
    end
    ...
    it 'expenses' do
      ...
      expect(site_map_transparency_expenses).to eq(expected)
    end
    ...
    it 'management' do
      ...
      expect(site_map_transparency_management).to eq(expected)
    end
    ...
    it 'maps' do
      ...
      expect(site_map_transparency_maps).to eq(expected)
    end
  end
  ...
  context 'SOU' do
    it 'default' do
      ...
      expect(site_map_sou_default).to eq(expected)
    end
  end
  ...
  context 'SIC' do
    it 'default' do
      ...
      expect(site_map_sic_default).to eq(expected)
    end

    it 'sensitive_information' do
      ...
      expect(site_map_sic_sensitive_information).to eq(expected)
    end
  end
  ...
  context 'services' do
    it 'default' do
      ...
      expect(site_map_services_default).to eq(expected)
    end
  end
end
