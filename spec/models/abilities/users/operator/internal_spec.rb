...
describe Abilities::Users::Operator::Internal do
  ...
  subject(:ability) { Abilities::Users::Operator::Internal.new(user) }
  ...
  describe 'User' do
    let(:other_operator) { create(:user, :operator_internal, department: department, organ: organ) }
  ...
  describe 'Ticket' do
    ...
    context 'manage' do
      ...
      it { is_expected.not_to be_able_to(:read, ticket_from_other_department) }

      it { is_expected.not_to be_able_to(:edit, Ticket) }
      it { is_expected.not_to be_able_to(:update, Ticket) }

      it { is_expected.to be_able_to(:create_ticket, Ticket) }
    end
