...
describe Reports::Tickets::Sic::MostWantedTopicsPresenter do
  ...
  subject(:presenter) { Reports::Tickets::Sic::MostWantedTopicsPresenter.new(report_scope, ticket_report) }
  ...
  describe 'self.call' do
    it 'initialize' do
      ...
      expect(Reports::Tickets::Sic::MostWantedTopicsPresenter).to have_received(:new).with(report_scope, ticket_report)
    end
  end
