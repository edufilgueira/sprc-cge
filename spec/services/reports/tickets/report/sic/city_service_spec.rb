...
describe Reports::Tickets::Report::Sic::CityService do
  ...
  let(:presenter) { Reports::Tickets::CityPresenter.new(report_scope, ticket_report) }

  subject(:service) { Reports::Tickets::Report::Sic::CityService.new(xls_workbook, ticket_report) }

  describe 'self.call' do
    it 'initialize and invoke call method' do
      service = double
      allow(Reports::Tickets::Report::Sic::CityService).to receive(:new) { service }
      allow(service).to receive(:call)

      Reports::Tickets::Report::Sic::CityService.call(xls_workbook, ticket_report)

      expect(Reports::Tickets::Report::Sic::CityService).to have_received(:new).with(xls_workbook, ticket_report)
  ...
  describe 'call service' do
    ...
    context 'worksheet' do
      it 'sheet_name' do
        expected = I18n.t("services.reports.tickets.sic.city.sheet_name")
