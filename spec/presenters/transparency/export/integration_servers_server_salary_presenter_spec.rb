...
describe Transparency::Export::IntegrationServersServerSalaryPresenter do

  subject(:server_salary_spreadsheet_presenter) do
    Transparency::Export::IntegrationServersServerSalaryPresenter.new(server_salary)
  end
  ...
  it 'spreadsheet_header' do
    ...
    expect(Transparency::Export::IntegrationServersServerSalaryPresenter.spreadsheet_header).to eq(expected)
  end
