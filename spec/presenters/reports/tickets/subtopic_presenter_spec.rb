...
describe Reports::Tickets::SubtopicPresenter do
  ...
  subject(:presenter) { Reports::Tickets::SubtopicPresenter.new(scope, ticket_report) }

  describe 'self.call' do
    it 'initialize' do
      allow(Reports::Tickets::SubtopicPresenter).to receive(:new)

      presenter

      expect(Reports::Tickets::SubtopicPresenter).to have_received(:new).with(scope, ticket_report)
    end
  end
