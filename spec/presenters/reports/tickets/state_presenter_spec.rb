...
describe Reports::Tickets::StatePresenter do
  ...
  subject(:presenter) { Reports::Tickets::StatePresenter.new(scope, ticket_report) }

  describe 'self.call' do
    it 'initialize' do
      allow(Reports::Tickets::StatePresenter).to receive(:new)

      presenter

      expect(Reports::Tickets::StatePresenter).to have_received(:new).with(scope, ticket_report)
    end
  end
