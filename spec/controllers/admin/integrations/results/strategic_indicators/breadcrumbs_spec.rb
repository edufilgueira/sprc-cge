...
describe Admin::Integrations::Results::StrategicIndicatorsController  do
  ...
  context 'index' do
    ...
    it 'breadcrumbs' do
      expected = [
        ...
        { title: I18n.t('admin.integrations.results.strategic_indicators.index.title'), url: '' }
      ]
  ...
  context 'show' do
    ...
    it 'breadcrumbs' do
      expected = [
        ...
        { title: I18n.t('admin.integrations.index.title'), url: admin_integrations_root_path },
        { title: I18n.t('admin.integrations.results.index.title'), url: admin_integrations_results_root_path },
        { title: I18n.t('admin.integrations.results.strategic_indicators.index.title'), url: admin_integrations_results_strategic_indicators_path },
