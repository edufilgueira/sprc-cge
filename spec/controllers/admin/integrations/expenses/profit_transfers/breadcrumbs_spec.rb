  ...
  context 'index' do
    ...
    it 'breadcrumbs' do
      expected = [
        ...
        { title: I18n.t('admin.integrations.expenses.profit_transfers.index.title'), url: '' }
      ]
  ...
  context 'show' do
    ...
    it 'breadcrumbs' do
      expected = [
        ...
        { title: I18n.t('admin.integrations.index.title'), url: admin_integrations_root_path },
        { title: I18n.t('admin.integrations.expenses.index.title'), url: admin_integrations_expenses_root_path },
        { title: I18n.t('admin.integrations.expenses.profit_transfers.index.title'), url: admin_integrations_expenses_profit_transfers_path },
