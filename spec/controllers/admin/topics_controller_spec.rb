...
describe Admin::TopicsController do
  ...
  it_behaves_like 'controllers/admin/base/index/xhr' do
    context 'filters' do
      it 'user_type' do
    ...
    describe '#delete' do
      ...
      context 'authorized' do
        ...
        context 'template' do
          ...
          it { is_expected.to render_template('admin/topics/delete') }
        end
        ...
        context 'valid' do
          it 'destroys' do
            ...
            expect do
              ...
              expected_flash = I18n.t('admin.topics.destroy.done', title: topic.title)
        ...
        context 'invalid' do
          ...
          it 'does not save' do
            ...
            expect do
              ...
              expected_flash = I18n.t('admin.topics.destroy.error')

              expect(response).to render_template('admin/topics/delete')
