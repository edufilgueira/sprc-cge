...
describe Operator::DepartmentsController do
  ...
  context 'index' do
    ...
    it 'breadcrumbs' do
      expected = [
        ...
        { title: I18n.t('operator.departments.index.title'), url: '' }
      ]
  ...
  context 'new' do
    ...
    it 'breadcrumbs' do
      expected = [
        { title: I18n.t('operator.home.index.title'), url: operator_root_path },
        { title: I18n.t('operator.departments.index.title'), url: operator_departments_path },
        { title: I18n.t('operator.departments.new.title'), url: '' }
      ]
    ...
    context 'helper methods' do
      it 'breadcrumbs' do
        expected = [
          { title: I18n.t('operator.home.index.title'), url: operator_root_path },
          { title: I18n.t('operator.departments.index.title'), url: operator_departments_path },
          { title: I18n.t('operator.departments.create.title'), url: '' }
        ]
