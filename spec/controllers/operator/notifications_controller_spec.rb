...
describe Operator::NotificationsController do
  ...
  describe '#index' do
    context 'behaviors' do
      ...
      it_behaves_like 'controllers/operator/base/index'
  ...
  describe '#show' do
    ...
    context 'authorized' do
      ...
      describe 'marked as read' do
        ...
        it { is_expected.to respond_with(:success) }
        it { is_expected.to render_template('operator/notifications/show') }
      end
    end
  end
    ...
    context 'unauthorized' do
     ...
     context 'authorized' do
      ...
      describe 'marked as unread' do
        ...
        it { is_expected.to redirect_to(operator_notifications_path) }
      end
    end
