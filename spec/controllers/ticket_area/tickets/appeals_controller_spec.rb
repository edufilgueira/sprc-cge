...
describe TicketArea::Tickets::AppealsController do
  let(:user) { create(:user) }
  let(:ticket) { create(:ticket, :sic, :replied, :call_center, :feedback) }
      ...
      context 'invalid' do
        it 'not saves' do
          expect do
            ...
            expect(controller).to set_flash.now.to(I18n.t('ticket_area.tickets.appeals.create.error'))
          ...
          context 'ticket parent' do
            ...
            it 'saves' do
              expect do
                ...
                expect(controller).to set_flash.to(I18n.t('ticket_area.tickets.appeals.create.done'))
            ...
            context 'clear call_center_responsible' do
              let(:ticket) { create(:ticket, :sic, :replied, :with_call_center_responsible) }
