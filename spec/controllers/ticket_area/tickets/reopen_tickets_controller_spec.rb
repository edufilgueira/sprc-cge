...
describe TicketArea::Tickets::ReopenTicketsController do

  let(:ticket) { create(:ticket, :replied) }
  let(:ticket_child) { create(:ticket, :with_parent, :replied, parent: ticket, extended: true, extended_second_time: true) }
  let(:ticket_sic) { create(:ticket, :sic, :with_parent, :replied, parent: ticket, extended: true, extended_second_time: true) }
      ...
      context 'invalid' do
        it 'not saves' do
          expect do
            ...
            expect(controller).to set_flash.now.to(I18n.t('ticket_area.tickets.reopen_tickets.create.sou.error'))
        ...
        context 'sic' do
          it 'saves' do
            expect do
              ...
              is_expected.to redirect_to(ticket_area_ticket_path(ticket))
              expect(controller).to set_flash.to(I18n.t('ticket_area.tickets.reopen_tickets.create.sic.done'))
              ...
              expect(ticket_sic.extended_second_time).to be_falsey
        ...
        context 'sou' do
          ...
          context 'ticket child' do
            ...
            it 'saves' do
              expect do
                ...
                is_expected.to redirect_to(ticket_area_ticket_path(ticket))
                expect(controller).to set_flash.to(I18n.t('ticket_area.tickets.reopen_tickets.create.sou.done'))
            ...
            context 'create ticket log' do
              ...
              it 'for ticket_child' do
                ...
                expect(ticket_log.responsible).to eq(ticket)
          ...
          context 'ticket parent' do
            ...
            context 'clear call_center_responsible' do
              let(:ticket) { create(:ticket, :replied, :with_call_center_responsible) }
