...
describe Platform::AttachmentsController do
    ...
    context 'authorized' do
      ...
      context 'when attachment belongs to user' do
        it 'destroys' do
          ...
          expect do
            ...
            expect(controller).to set_flash.to(I18n.t('platform.attachments.destroy.done') % { title: attachment.title })
      ...
      context 'redirect to ticket' do
        ...
        context 'when ticket attachment' do
          ...
          it { expect(response).to redirect_to(platform_ticket_path(ticket)) }
        end
