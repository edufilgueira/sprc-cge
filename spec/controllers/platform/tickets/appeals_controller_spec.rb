...
describe Platform::Tickets::AppealsController do
  let(:user) { create(:user) }
  let(:ticket) { create(:ticket, :sic, :replied, :call_center, :feedback, created_by: user) }
      ...
      context 'invalid' do
        it 'not saves' do
          expect do
            ...
            expect(controller).to set_flash.now.to(I18n.t('platform.tickets.appeals.create.error'))
          ...
          context 'ticket parent' do
            ...
            it 'saves' do
              expect do
                ...
                expect(controller).to set_flash.to(I18n.t('platform.tickets.appeals.create.done'))
            ...
            it 'create ticket log' do
              ...
              expect(ticket_log.data[:count]).to eq(ticket.reload.appeals)
            end
