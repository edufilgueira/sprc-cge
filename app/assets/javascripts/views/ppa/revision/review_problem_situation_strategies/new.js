...
function _getSelectedRegion(){
  return $('#ppa_revision_review_problem_situation_strategy_region_code :selected').val();
}
...
$("#ppa_revision_review_problem_situation_strategy_region_code").change(function(){
...
function updateAxisAndThemeLabel() {
  var label=$('#ppa_revision_review_problem_situation_strategy_region_code :selected').parent().attr('label');
