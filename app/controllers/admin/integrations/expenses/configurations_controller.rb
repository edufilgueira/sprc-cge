class Admin::Integrations::Expenses::ConfigurationsController < Admin::Integrations::BaseConfigurationsController
  include Admin::Integrations::Expenses::Configurations::Breadcrumbs
